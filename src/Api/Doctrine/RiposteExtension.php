...
use App\Entity\Riposte;
use Doctrine\ORM\QueryBuilder;

class RiposteExtension implements QueryItemExtensionInterface, QueryCollectionExtensionInterface
{
    ...
    private function modifyQuery(QueryBuilder $queryBuilder, string $resourceClass): void
    {
        ...
        $queryBuilder
            ->andWhere("$alias.enabled = :true AND $alias.createdBy > :last_24")
